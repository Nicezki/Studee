...
class _EditItemState extends State<EditItem> {
  ...
  initState() {
    ...
    _controllerTeacher =
        TextEditingController(text: widget.shoppingItem['Teacher']);
    _controllerPlace =
        TextEditingController(text: widget.shoppingItem['Place']);
    _controllerDetails =
        TextEditingController(text: widget.shoppingItem['Details']);
    _controllerStart =
        TextEditingController(text: widget.shoppingItem['Start']);
          ...
          child: Column(
            children: [
              TextFormField(
                ...
                decoration: InputDecoration(hintText: 'Enter the Subject Code'),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(hintText: 'Enter the Subject name'),
                validator: (String? value) {
                  if (value == null || value.isEmpty) {
              ...
              TextFormField(
                ...
                decoration: InputDecoration(hintText: 'Enter the Details'),
                validator: (String? value) {
                  if (value == null || value.isEmpty) {
              ...
              TextFormField(
                ...
                decoration: InputDecoration(hintText: 'Enter the Start time'),
                validator: (String? value) {
                  if (value == null || value.isEmpty) {
              ...
              TextFormField(
                ...
                decoration: InputDecoration(hintText: 'Enter the End time'),
                validator: (String? value) {
                  if (value == null || value.isEmpty) {
